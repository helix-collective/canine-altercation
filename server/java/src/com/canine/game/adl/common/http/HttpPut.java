...
public class HttpPut<I, O> {
  ...
  public HttpPut(String path, HashSet<String> roles, TypeToken<I> reqType, TypeToken<O> respType) {
  ...
  public boolean equals(Object other0) {
    if (!(other0 instanceof HttpPut)) {
      return false;
    }
    HttpPut<?, ?> other = (HttpPut<?, ?>) other0;
    return
  ...
  public static <I, O> Factory<HttpPut<I, O>> factory(Factory<I> factoryI, Factory<O> factoryO) {
    return new Factory<HttpPut<I, O>>() {
      ...
      @Override
      public HttpPut<I, O> create() {
        return new HttpPut<I, O>(
          path.get().create(),
          roles.get().create(),
      ...
      @Override
      public HttpPut<I, O> create(HttpPut<I, O> other) {
        return new HttpPut<I, O>(
          other.getPath(),
      ...
      public TypeExpr typeExpr() {
        ScopedName scopedName = new ScopedName("common.http", "HttpPut");
      ...
      @Override
      public JsonBinding<HttpPut<I, O>> jsonBinding() {
        return HttpPut.jsonBinding(factoryI.jsonBinding(), factoryO.jsonBinding());
      }
    };
  }
  ...
  public static<I, O> JsonBinding<HttpPut<I, O>> jsonBinding(JsonBinding<I> bindingI, JsonBinding<O> bindingO) {
    ...
    final Factory<HttpPut<I, O>> _factory = factory(bindingI.factory(), bindingO.factory());

    return new JsonBinding<HttpPut<I, O>>() {
      @Override
      public Factory<HttpPut<I, O>> factory() {
        return _factory;
      }

      @Override
      public JsonElement toJson(HttpPut<I, O> _value) {
      ...
      @Override
      public HttpPut<I, O> fromJson(JsonElement _json) {
